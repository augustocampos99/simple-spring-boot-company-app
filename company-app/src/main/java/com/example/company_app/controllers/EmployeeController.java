...
public class EmployeeController {
    ...
    public ResponseEntity save(@Validated @RequestBody EmployeeRequestDTO request) {
        try {
    ...
    public ResponseEntity update(@PathVariable UUID id, @Validated @RequestBody EmployeeRequestDTO request) {
        try {
